...
Al ser un framework extenso que no se emplea en su totalidad en el proyecto, se explicarán a continuación las funcionalidades del mismo empleadas por DDColor, así como las diferencias entre la implementación de DDColor encontrada en el directorio \texttt{ddcolor} y la que forma parte de \texttt{BasicSR}.
...
Este módulo implementa una versión modificada de la función de generación de \textit{embeddings} posicionales empleada en \cite{Attention}.
