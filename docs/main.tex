...
\begin{enumerate}
  ...
  \item{\textbf{Red feed-forward} empleando el resultado de la anterior como entrada. Se trata de una red neuronal convencional, empleando dos capas lineales con una capa de \textit{drop-out} entre las mismas (la cual cambia aleatoriamente a cero determinados valores en base a una probabilidad), así como una capa de normalización y una activación ReLU.}
\end{enumerate}
...
Mide cuánto de ``colorida'' o ``vívida'' es una imagen. Se basa en la distribución de colores en el espacio RG-YB (rojo-verde, amarillo-azul). 
